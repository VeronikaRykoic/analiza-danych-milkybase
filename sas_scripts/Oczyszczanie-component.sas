...
DATA _NULL_;
    FILE kody;
    put 'DATA WORK.MLEKO_OCZYSZCZONE; SET WORK.MLEKO; DROP ';
RUN;
DATA _NULL_;
    FILE kody MOD;
    SET do_usuniecia;
...
PROC EXPORT DATA=WORK.MLEKO_OCZYSZCZONE
    OUTFILE="/home/u64469782/sasuser.v94/Prawie_Oczyszczone_mleko.xlsx" 
    DBMS=XLSX REPLACE;
RUN;